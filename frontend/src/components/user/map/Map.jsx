...
const redIcon = L.icon({
  iconUrl:
    "https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-icon-2x.png", // Valid red marker URL
  ...
  shadowUrl:
    "https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.7.1/images/marker-shadow.png", // Optional: Shadow for the marker
  ...
  return (
    <div className="map">
      <h1>
        ...
        veniam. Consectetur sit sapiente quas. Minima ipsum et maiores tempore
        saepe, ullam, rem vel quisquam corporis laborum ad cupiditate magni
        quod!
      </h1>
      <MapContainer
